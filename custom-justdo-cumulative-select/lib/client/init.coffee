...
CustomJustdoCumulativeSelect = (options) ->
  # skeleton-version: v0.0.17-client-only
  ...
  @logger = Logger.get("custom-justdo-cumulative-select")

  @logger.debug "Init begin"
  @JA = JustdoAnalytics.setupConstructorJA(@, "custom-justdo-cumulative-select")
...
Util.inherits CustomJustdoCumulativeSelect, EventEmitter

Package.describe({
  name: "justdoinc:custom-justdo-cumulative-select",
  version: "1.0.0",
  summary: "",
  git: "https://github.com/justdoinc/justdo-shared-packages/tree/master/custom-justdo-cumulative-select"
});
...
Package.onUse(function (api) {
  ...
  //   checkNpmVersions({
  //     'colors': '1.1.x'
  //   }, 'justdoinc:custom-justdo-cumulative-select')

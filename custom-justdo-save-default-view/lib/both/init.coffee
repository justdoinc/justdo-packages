...
CustomJustdoSaveDefaultView = (options) ->
  ...
  @logger = Logger.get("custom-justdo-save-default-view")
  @JA = JustdoAnalytics.setupConstructorJA(@, "custom-justdo-save-default-view")
...
Util.inherits CustomJustdoSaveDefaultView, EventEmitter

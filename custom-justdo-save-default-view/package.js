Package.describe({
  name: "justdoinc:custom-justdo-save-default-view",
  version: "1.0.0",
  summary: "",
  git: "https://github.com/justdoinc/justdo-shared-packages/tree/master/custom-justdo-save-default-view"
});
...
Package.onUse(function (api) {
  ...
  //   checkNpmVersions({
  //     'colors': '1.1.x'
  //   }, 'justdoinc:custom-justdo-save-default-view')
  ...
  api.export("CustomJustdoSaveDefaultView", both);
});

...
CustomJustdoTasksLocks = (options) ->
  ...
  @logger = Logger.get("custom-justdo-tasks-locks")
  @JA = JustdoAnalytics.setupConstructorJA(@, "custom-justdo-tasks-locks")
...
Util.inherits CustomJustdoTasksLocks, EventEmitter

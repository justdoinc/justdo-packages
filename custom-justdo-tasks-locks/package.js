Package.describe({
  name: "justdoinc:custom-justdo-tasks-locks",
  version: "1.0.0",
  summary: "",
  git: "https://github.com/justdoinc/justdo-shared-packages/tree/master/custom-justdo-tasks-locks"
});
...
Package.onUse(function (api) {
  ...
  //   checkNpmVersions({
  //     'colors': '1.1.x'
  //   }, 'justdoinc:custom-justdo-tasks-locks')
  ...
  api.addFiles("lib/client/task-pane-details-section/task-pane-details-section.sass", client);
  api.addFiles("lib/client/task-pane-details-section/task-pane-details-section.html", client);
  api.addFiles("lib/client/task-pane-details-section/task-pane-details-section.coffee", client);
  ...
  api.export("CustomJustdoTasksLocks", both);
});

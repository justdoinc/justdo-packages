default_grid_control_domain = "anonymous"
...
_.extend GridControl,
  ...
  Options:
    tab_id: The tab_id to get grid_control_options from, defaults to "main"
    container: The container element or selector for the new GridControl
    sections_state: Initial sections state to set after GridControl is created
...
_.extend GridControl.prototype,
  ...
  activateRow: (row, cell = 0, scroll_into_view = true, resulted_from_smart_guess = false) ->
    ...
    # The actual activation is wrapped in a Tracker.afterFlush 
    # is to ensure any DOM updates caused by "pre-activate-row" event is finished,
  ...
  generateFieldEditor: (field_id, item_id, custom_editor) ->
    ...
    editor_context = {
        ...
        container: $container
        column: {id: field_id, field: field_id, values: field_def.grid_values, removed_values: field_def.grid_removed_values}

...
JustdoAnalyticsCoreLogs = (options) ->
  ...
  @logger = Logger.get("justdo-analytics-core-logs")
  @JA = JustdoAnalytics.setupConstructorJA(@, "core")
...
Util.inherits JustdoAnalyticsCoreLogs, EventEmitter

...
# APP.justdo_backend_calculated_fields = new JustdoBackendCalculatedFields()
...
APP.getEnv (env) ->
  APP.executeAfterAppLibCode ->
    ...
    APP.justdo_backend_calculated_fields = new JustdoBackendCalculatedFields(options)

    if Meteor.isClient
      APP.justdo_backend_calculated_fields.setupParamsFieldEditorSystemMessagesClearer()

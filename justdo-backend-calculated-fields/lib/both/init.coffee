...
options_schema =
  both:
    ...
    custom_feature_id:
      type: "string"
      optional: false
      defaultValue: "backend-calculated-fields"
...
JustdoBackendCalculatedFields = (options) ->
  # skeleton-version: v0.0.9
  ...
  @logger = Logger.get("justdo-backend-calculated-fields")
  @JA = JustdoAnalytics.setupConstructorJA(@, "justdo-backend-calculated-fields")
...
Util.inherits JustdoBackendCalculatedFields, EventEmitter

Package.describe({
  name: "justdoinc:justdo-backend-calculated-fields",
  version: "1.0.0",
  summary: "",
  git: "https://github.com/justdoinc/justdo-shared-packages/tree/master/justdo-backend-calculated-fields"
});
...
Package.onUse(function (api) {
  ...
  api.addFiles("lib/server/cache-manager.coffee", server);
  ...
  api.addFiles("lib/client/project-configuration/project-configuration.sass", client);
  api.addFiles("lib/client/project-configuration/project-configuration.html", client);
  api.addFiles("lib/client/project-configuration/project-configuration.coffee", client);
  ...
  api.export("JustdoBackendCalculatedFields", both);
});

Package.describe({
  name: "justdoinc:justdo-bottom-windows-wireframe",
  version: "1.0.0",
  summary: "",
  git: "https://github.com/justdoinc/justdo-shared-packages/tree/master/justdo-bottom-windows-wireframe"
});
...
Package.onUse(function (api) {
  ...
  api.addFiles("lib/ui/style.sass", client);
  ...
  api.export("BottomWindowsWireframe", client);
});

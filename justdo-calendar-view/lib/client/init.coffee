...
JustdoCalendarView = (options) ->
  # skeleton-version: v0.0.16-client-only
  ...
  @logger = Logger.get("justdo-calendar-view")

  @logger.debug "Init begin"
  @JA = JustdoAnalytics.setupConstructorJA(@, "justdo-calendar-view")
...
Util.inherits JustdoCalendarView, EventEmitter

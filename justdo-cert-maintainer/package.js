Package.describe({
  name: "justdoinc:justdo-cert-maintainer",
  version: "1.0.0",
  summary: "",
  git: "https://github.com/justdoinc/justdo-shared-packages/tree/master/justdo-cert-maintainer"
});
...
Package.onUse(function (api) {
  ...
  //   checkNpmVersions({
  //     'colors': '1.1.x'
  //   }, 'justdoinc:justdo-cert-maintainer')
  ...
  api.addAssets("lib/assets/cacert.pem", server)
  ...
  api.export("JustdoCertMaintainer", both);
});

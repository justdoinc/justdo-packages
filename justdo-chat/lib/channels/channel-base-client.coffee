...
_.extend ChannelBaseClient.prototype,
  ...
  _setupFilesSubscription: ->
    ...
    @_files_subscription = APP.justdo_file_interface.subscribeToFilesCollection null, {task_id: @getChannelIdentifier().task_id} 
  ...
  exitFocusMode: ->
    ...
    @_focus_mode_channel_auto_read_setter_comp?.stop()
    @_focus_mode_channel_auto_read_setter_comp = null

...
Template.task_pane_chat_section_chat.helpers
  ...
  subscribersDisplayNames: (limit=10) ->
    ...
    task_members_doc = JustdoHelpers.getUsersDocsByIds(subscribers_ids, {ret_type: "array", user_fields_reactivity: false, missing_users_reactivity: true, get_docs_by_reference: true, find_options: {limit: limit}})

...
JustdoChecklist = (options) ->
  ...
  @logger = Logger.get("justdo-checklist")
  @JA = JustdoAnalytics.setupConstructorJA(@, "justdo-checklist")
...
Util.inherits JustdoChecklist, EventEmitter

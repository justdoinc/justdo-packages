Package.describe({
  name: "justdoinc:justdo-checklist",
  version: "1.0.0",
  summary: "",
  git: "https://github.com/justdoinc/justdo-shared-packages/tree/master/justdo-checklist"
});
...
Package.onUse(function (api) {
  ...
  api.addFiles("lib/client/on-grid-mark/on-grid-mark.coffee", client);
  api.addFiles("lib/client/on-grid-mark/on-grid-mark.sass", client);
  ...
  api.export("JustdoChecklist", both);
});

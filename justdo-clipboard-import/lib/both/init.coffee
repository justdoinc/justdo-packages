...
JustdoClipboardImport = (options) ->
  ...
  @logger = Logger.get("justdo-clipboard-import")
  @JA = JustdoAnalytics.setupConstructorJA(@, "justdo-clipboard-import")
...
Util.inherits JustdoClipboardImport, EventEmitter

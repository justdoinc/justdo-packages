Package.describe({
  name: "justdoinc:justdo-color-picker-dropdown",
  version: "1.0.0",
  summary: "",
  git: "https://github.com/justdoinc/justdo-shared-packages/tree/master/justdo-color-picker-dropdown"
});
...
Package.onUse(function (api) {
  ...
  api.addFiles("lib/ui/color-picker-dropdown/color-picker-dropdown-controller.coffee", client);
  api.addFiles("lib/ui/color-picker-dropdown/color-picker-dropdown.sass", client);
  api.addFiles("lib/ui/color-picker-dropdown/color-picker-dropdown.html", client);
  api.addFiles("lib/ui/color-picker-dropdown/color-picker-dropdown.coffee", client);
  ...
  api.export("JustdoColorPickerDropdownController", client);
});

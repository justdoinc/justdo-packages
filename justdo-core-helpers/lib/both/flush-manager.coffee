...
FlushManager = (options) ->
  ...
  JustdoCoreHelpers.loadEventEmitterHelperMethods(@)
...
_.extend FlushManager.prototype,
  ...
  _isFlushRequestedInThisTick: ->
    return JustdoCoreHelpers.sameTickCacheGet(@_same_tick_cache_key)?

  _setFlushRequestedInThisTick: ->
    return JustdoCoreHelpers.sameTickCacheSet(@_same_tick_cache_key, true)

  _unsetFlushRequestedInThisTick: ->
    return JustdoCoreHelpers.sameTickCacheSet(@_same_tick_cache_key, null)
...
JustdoCoreHelpers.FlushManager = FlushManager
...
JustdoCustomPlugins = (options) ->
  ...
  @logger = Logger.get("justdo-custom-plugins")
  @JA = JustdoAnalytics.setupConstructorJA(@, "justdo-custom-plugins")
...
Util.inherits JustdoCustomPlugins, EventEmitter

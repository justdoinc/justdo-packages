_.extend JustdoCustomPlugins.prototype,
  ...
  #   console.log "Plugin #{JustdoCustomPlugins.project_custom_feature_id} installed on project #{project_doc._id}"
  ...
  #   console.log "Plugin #{JustdoCustomPlugins.project_custom_feature_id} removed from project #{project_doc._id}"

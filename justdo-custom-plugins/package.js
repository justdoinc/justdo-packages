Package.describe({
  name: "justdoinc:justdo-custom-plugins",
  version: "1.0.0",
  summary: "",
  git: "https://github.com/justdoinc/justdo-shared-packages/tree/master/justdo-custom-plugins"
});
...
Package.onUse(function (api) {
  ...
  //   checkNpmVersions({
  //     'colors': '1.1.x'
  //   }, 'justdoinc:justdo-custom-plugins')
  ...
  api.addFiles("lib/core-custom-plugins/merge-justdo/merge-justdo-templates.html", client);
  ...
  api.addFiles("lib/core-custom-plugins/justdo-task-duration/both.coffee", both);
  api.addFiles("lib/core-custom-plugins/justdo-task-duration/server.coffee", server);
  api.addFiles("lib/core-custom-plugins/justdo-task-duration/client.coffee", client);

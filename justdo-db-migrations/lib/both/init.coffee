...
JustdoDbMigrations = (options) ->
  ...
  @logger = Logger.get("justdo-db-migrations")
  @JA = JustdoAnalytics.setupConstructorJA(@, "justdo-db-migrations")
...
Util.inherits JustdoDbMigrations, EventEmitter

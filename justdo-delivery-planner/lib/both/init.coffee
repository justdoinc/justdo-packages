...
JustdoDeliveryPlanner = (options) ->
  ...
  @logger = Logger.get("justdo-delivery-planner")
  @JA = JustdoAnalytics.setupConstructorJA(@, "justdo-delivery-planner")
...
Util.inherits JustdoDeliveryPlanner, EventEmitter

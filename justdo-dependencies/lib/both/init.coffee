...
JustdoDependencies = (options) ->
  ...
  @logger = Logger.get("justdo-dependencies")
  @JA = JustdoAnalytics.setupConstructorJA(@, "justdo-dependencies")
...
Util.inherits JustdoDependencies, EventEmitter

Package.describe({
  name: "justdoinc:justdo-dependencies",
  version: "1.0.0",
  summary: "",
  git: "https://github.com/justdoinc/justdo-shared-packages/tree/master/justdo-dependencies"
});
...
Package.onUse(function (api) {
  ...
  api.use("justdoinc:justdo-chat", server);
  ...
  api.export("JustdoDependencies", both);
});

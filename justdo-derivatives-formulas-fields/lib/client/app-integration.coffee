...
# APP.justdo_derivatives_formulas_fields = new JustdoDerivativesFormulasFields()
...
APP.getEnv (env) ->
  ...
  APP.justdo_derivatives_formulas_fields = new JustdoDerivativesFormulasFields(options)

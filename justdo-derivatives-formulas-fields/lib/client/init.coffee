...
JustdoDerivativesFormulasFields = (options) ->
  # skeleton-version: v3.0.1-client-only
  ...
  @logger = Logger.get("justdo-derivatives-formulas-fields")

  @logger.debug "Init begin"
  @JA = JustdoAnalytics.setupConstructorJA(@, "justdo-derivatives-formulas-fields")
...
Util.inherits JustdoDerivativesFormulasFields, EventEmitter

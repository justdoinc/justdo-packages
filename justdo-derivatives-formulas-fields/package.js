Package.describe({
  name: "justdoinc:justdo-derivatives-formulas-fields",
  version: "1.0.0",
  summary: "",
  git: "https://github.com/justdoinc/justdo-shared-packages/tree/master/justdo-derivatives-formulas-fields"
});
...
Package.onUse(function (api) {
  ...
  //   checkNpmVersions({
  //     'colors': '1.1.x'
  //   }, 'justdoinc:justdo-derivatives-formulas-fields')
  ...
  api.addFiles("lib/client/derivatives-formulas-formatter/derivatives-formulas-formatter.coffee", client);
  api.addFiles("lib/client/derivatives-formulas-formatter/derivatives-formulas-formatter.sass", client);
  ...
  api.export("JustdoDerivativesFormulasFields", client);
});

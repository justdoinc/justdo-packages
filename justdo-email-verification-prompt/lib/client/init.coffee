...
JustdoEmailVerificationPrompt = (options) ->
  ...
  @logger = Logger.get("justdo-email-verification-prompt")

  @logger.debug "Init begin"
  @JA = JustdoAnalytics.setupConstructorJA(@, "justdo-email-verification-prompt")
...
Util.inherits JustdoEmailVerificationPrompt, EventEmitter

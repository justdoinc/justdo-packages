Package.describe({
  name: "justdoinc:justdo-email-verification-prompt",
  version: "1.0.0",
  summary: "",
  git: "https://github.com/justdoinc/justdo-shared-packages/tree/master/justdo-email-verification-prompt"
});
...
Package.onUse(function (api) {
  ...
  api.addFiles("lib/client/email-verification-required-dialog/email-verification-required-dialog.html", client);
  api.addFiles("lib/client/email-verification-required-dialog/email-verification-required-dialog.coffee", client);
  api.addFiles("lib/client/email-verification-required-dialog/email-verification-required-dialog.sass", client);
  ...
  api.export("JustdoEmailVerificationPrompt", client);
});

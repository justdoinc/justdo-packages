_.extend JustdoFilesInterface.prototype,
  ...
  _validateOptionsWithRequiredProperties: (fs_obj, required_properties) ->
  ...
  registerFs: (fs_id, fs_obj) ->
    ...
    @_validateOptionsWithRequiredProperties fs_obj, JustdoFilesInterface.both_register_fs_options_required_properties
    if Meteor.isClient
      @_validateOptionsWithRequiredProperties fs_obj, JustdoFilesInterface.client_register_fs_options_required_properties
    if Meteor.isServer
      @_validateOptionsWithRequiredProperties fs_obj, JustdoFilesInterface.server_register_fs_options_required_properties

...
# APP.justdo_formula_fields = new JustdoFormulaFields()
...
APP.getEnv (env) ->
  APP.collections.Formulas = new Mongo.Collection("grids_formulas")

  options =
    projects_collection: APP.collections.Projects
    tasks_collection: APP.collections.Tasks
    formulas_collection: APP.collections.Formulas

_.extend JustdoFormulaFields.prototype,
  ...
  _errors_types:
    _.extend {}, JustdoHelpers.common_errors_types,
      "no-grid-control-loaded": "This method can be called only in the presence of a grid control object"
      "plugin-not-installed-for-project": "Plugin not installed for project"
...
JustdoFormulaFields = (options) ->
  ...
  @logger = Logger.get("justdo-formula-fields")
  @JA = JustdoAnalytics.setupConstructorJA(@, "justdo-formula-fields")
...
Util.inherits JustdoFormulaFields, EventEmitter

Package.describe({
  name: "justdoinc:justdo-formula-fields",
  version: "1.0.0",
  summary: "",
  git: "https://github.com/justdoinc/justdo-shared-packages/tree/master/justdo-formula-fields"
});
...
Package.onUse(function (api) {
  ...
  api.addFiles("lib/client/formula-editing-rules/formula-editing-rules.sass", client);
  api.addFiles("lib/client/formula-editing-rules/formula-editing-rules.html", client);
  api.addFiles("lib/client/formula-editing-rules/formula-editing-rules.coffee", client);
  ...
  api.export("JustdoFormulaFields", both);
});

...
JustdoGlobalActivityLog = (options) ->
  # skeleton-version: v0.0.13
  ...
  @logger = Logger.get("justdo-global-activity-log")
  @JA = JustdoAnalytics.setupConstructorJA(@, "justdo-global-activity-log")
...
Util.inherits JustdoGlobalActivityLog, EventEmitter

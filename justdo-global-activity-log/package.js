Package.describe({
  name: "justdoinc:justdo-global-activity-log",
  version: "1.0.0",
  summary: "",
  git: "https://github.com/justdoinc/justdo-shared-packages/tree/master/justdo-global-activity-log"
});
...
Package.onUse(function (api) {
  ...
  api.use("justdoinc:justdo-project-pane@1.0.0", client);
  ...
  api.addFiles("lib/client/project-pane-project-activity/project-pane-project-activity.sass", client);
  api.addFiles("lib/client/project-pane-project-activity/project-pane-project-activity.html", client);
  api.addFiles("lib/client/project-pane-project-activity/project-pane-project-activity.coffee", client);
  ...
  api.export("JustdoGlobalActivityLog", both);
});

...
JustdoGridGantt = (options) ->
  ...
  @logger = Logger.get("justdo-grid-gantt")

  @logger.debug "Init begin"
  @JA = JustdoAnalytics.setupConstructorJA(@, "justdo-grid-gantt")
...
Util.inherits JustdoGridGantt, EventEmitter

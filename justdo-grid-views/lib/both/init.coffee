...
JustdoGridViews = (options) ->
  ...
  @logger = Logger.get("justdo-grid-views")
  @JA = JustdoAnalytics.setupConstructorJA(@, "justdo-grid-views")
...
Util.inherits JustdoGridViews, EventEmitter

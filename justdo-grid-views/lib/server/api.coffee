_.extend JustdoGridViews.prototype,
  ...
  performInstallProcedures: (project_doc, user_id) ->
    ...
    console.log "Plugin #{JustdoGridViews.project_custom_feature_id} installed on project #{project_doc._id}"
  ...
  performUninstallProcedures: (project_doc, user_id) ->
    ...
    console.log "Plugin #{JustdoGridViews.project_custom_feature_id} removed from project #{project_doc._id}"

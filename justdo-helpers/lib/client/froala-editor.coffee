_.extend JustdoHelpers,
  ...
  createFroalaEditor: (selector, options = {}) ->
    ...
    default_options = 
      toolbarButtons: ["undo", "redo", "fontFamily", "fontSize", "bold", "italic", "underline", "backgroundColor", "textColor", "align", "formatOL", "formatUL", "outdent", "indent", "quote", "insertLink", "insertTable",  "strikeThrough", "clearFormatting"]
      colorsText: ["#ffffff", "#dee5e8", "#90a4ae", "#455a64", "#37474f", "#000000", "#f44336", "#ffcdd2", "#fb9797", "#d32f2f", "#b71c1c", "#6f0505", "#9D4EDD", "#E0AAFF", "#C77DFF", "#7B2CBF", "#5A189A", "#3C096C", "#3f51b5",
      "#c5cae9", "#7986cb", "#303f9f", "#1a237e", "#080f5d", "#03a9f4", "#b3e5fc", "#4fc3f7", "#0288d1", "#01579b", "#023d6b", "#2dca33", "#CCFF33", "#9EF01A", "#38B000", "#008000", "#006400", "#FFD000", "#FFEA00", "#FFDD00",
      "#FFB700", "#FFA200", "#de7702", "#FC8E4A", "#FED9C2", "#FDB486", "#FB690E", "#C94F03", "#8D3702"]
      colorsBackground: ["#ffffff", "#dee5e8", "#90a4ae", "#455a64", "#37474f", "#000000", "#f44336", "#ffcdd2", "#fb9797", "#d32f2f", "#b71c1c", "#6f0505", "#9D4EDD", "#E0AAFF", "#C77DFF", "#7B2CBF", "#5A189A", "#3C096C", "#3f51b5",
      "#c5cae9", "#7986cb", "#303f9f", "#1a237e", "#080f5d", "#03a9f4", "#b3e5fc", "#4fc3f7", "#0288d1", "#01579b", "#023d6b", "#2dca33", "#CCFF33", "#9EF01A", "#38B000", "#008000", "#006400", "#FFD000", "#FFEA00", "#FFDD00",
      "#FFB700", "#FFA200", "#de7702", "#FC8E4A", "#FED9C2", "#FDB486", "#FB690E", "#C94F03", "#8D3702"]
      colorsButtons: ['textColor', 'backgroundColor', '|', 'removeTextColor', 'removeFormat'],
      tableStyles:

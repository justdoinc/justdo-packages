...
JustdoI18nRoutes = (options) ->
  ...
  @logger = Logger.get("justdo-i18n-routes")
  @JA = JustdoAnalytics.setupConstructorJA(@, "justdo-i18n-routes")
...
Util.inherits JustdoI18nRoutes, EventEmitter

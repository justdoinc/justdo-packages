...
JustdoJiraIntegration = (options) ->
  ...
  @logger = Logger.get("justdo-jira-integration")
  @JA = JustdoAnalytics.setupConstructorJA(@, "justdo-jira-integration")
...
Util.inherits JustdoJiraIntegration, EventEmitter

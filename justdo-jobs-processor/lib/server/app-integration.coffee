...
# APP.justdo_jobs_processor = new JustdoJobsProcessor()
...
APP.justdo_jobs_processor = new JustdoJobsProcessor
  configuration_string: process.env.JUSTDO_JOBS_PROCESSOR_CONF
  group_id: process.env.JUSTDO_JOBS_PROCESSOR_GROUP_ID

...
JustdoLicensingCe = (options) ->
  ...
  @logger = Logger.get("justdo-licensing-ce")
  @JA = JustdoAnalytics.setupConstructorJA(@, "justdo-licensing-ce")
...
Util.inherits JustdoLicensingCe, EventEmitter

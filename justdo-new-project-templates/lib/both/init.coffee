...
JustdoNewProjectTemplates = (options) ->
  ...
  @logger = Logger.get("justdo-new-project-templates")
  @JA = JustdoAnalytics.setupConstructorJA(@, "justdo-new-project-templates")
...
Util.inherits JustdoNewProjectTemplates, EventEmitter

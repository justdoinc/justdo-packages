...
JustdoNewsData = (options) ->
  ...
  @logger = Logger.get("justdo-news-data")

  @logger.debug "Init begin"
  @JA = JustdoAnalytics.setupConstructorJA(@, "justdo-news-data")
...
Util.inherits JustdoNewsData, EventEmitter

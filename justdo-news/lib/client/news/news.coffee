...
Template.news.helpers
  getActiveNewsTitle: ->
    ...
    return TAPi18n.__ APP.justdo_crm.getItemByIdOrAlias(tpl.active_category_rv.get(), tpl.active_news_id_rv.get())?.news_doc?.title
  ...
  otherNews: ->
    tpl = Template.instance()
    return APP.justdo_crm.getAllItemsByCategory(tpl.active_category_rv.get())
  ...
  activeNews: ->
    tpl = Template.instance()
    return APP.justdo_crm.getItemByIdOrAlias(tpl.active_category_rv.get(), tpl.active_news_id_rv.get())?.news_doc
  ...
  getActiveNewsTemplate: ->
    tpl = Template.instance()
    news_doc = APP.justdo_crm.getItemByIdOrAlias(tpl.active_category_rv.get(), tpl.active_news_id_rv.get())?.news_doc

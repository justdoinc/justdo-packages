...
JustdoPermissions = (options) ->
  ...
  @logger = Logger.get("justdo-permissions")
  @JA = JustdoAnalytics.setupConstructorJA(@, "justdo-permissions")
...
Util.inherits JustdoPermissions, EventEmitter

Package.describe({
  name: "justdoinc:justdo-permissions",
  version: "1.0.0",
  summary: "",
  git: "https://github.com/justdoinc/justdo-shared-packages/tree/master/justdo-permissions"
});
...
Package.onUse(function (api) {
  ...
  api.use("justdoinc:justdo-tasks-collections-manager", both);
  ...
  api.addFiles("lib/client/blaze-helpers.coffee", client);
  ...
  api.export("JustdoPermissions", both);
});

...
JustdoPickerMiddlewares = (options) ->
  ...
  @logger = Logger.get("justdo-picker-middlewares")
  @JA = JustdoAnalytics.setupConstructorJA(@, "justdo-picker-middlewares")
...
Util.inherits JustdoPickerMiddlewares, EventEmitter

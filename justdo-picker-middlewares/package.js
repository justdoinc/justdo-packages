Package.describe({
  name: "justdoinc:justdo-picker-middlewares",
  version: "1.0.0",
  summary: "",
  git: "https://github.com/justdoinc/justdo-shared-packages/tree/master/justdo-picker-middlewares"
});
...
Package.onUse(function (api) {
  ...
  api.export("JustdoPickerMiddlewares", server);
});

...
JustdoPluginStore = (options) ->
  ...
  @logger = Logger.get("justdo-plugin-store")
  @JA = JustdoAnalytics.setupConstructorJA(@, "justdo-plugin-store")
...
Util.inherits JustdoPluginStore, EventEmitter

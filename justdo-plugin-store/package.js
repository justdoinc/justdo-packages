...
Package.onUse(function (api) {
  ...
  // Categories
  this.addI18nFiles(api, "store-db/i18n/categories.{}.i18n.json");

  // Calculated due dates
  this.addI18nFiles(api, "store-db/plugins/calculated-due-dates/i18n/{}.i18n.json");
  this.addI18nFiles(api, "store-db/plugins/calculated-due-dates/i18n/seo.{}.i18n.json");

  // Gantt Chart
  this.addI18nFiles(api, "store-db/plugins/gantt-chart/i18n/{}.i18n.json");
  this.addI18nFiles(api, "store-db/plugins/gantt-chart/i18n/seo.{}.i18n.json");
  this.addI18nFiles(api, "store-db/plugins/gantt-chart/i18n/asset.{}.i18n.json");

  // Activities
  this.addI18nFiles(api, "store-db/plugins/justdo-activity/i18n/{}.i18n.json");
  this.addI18nFiles(api, "store-db/plugins/justdo-activity/i18n/seo.{}.i18n.json");
  this.addI18nFiles(api, "store-db/plugins/justdo-activity/i18n/asset.{}.i18n.json");

  // Calendar View
  this.addI18nFiles(api, "store-db/plugins/justdo-calendar-view/i18n/{}.i18n.json");
  this.addI18nFiles(api, "store-db/plugins/justdo-calendar-view/i18n/seo.{}.i18n.json");
  this.addI18nFiles(api, "store-db/plugins/justdo-calendar-view/i18n/asset.{}.i18n.json");

  // Checklist
  this.addI18nFiles(api, "store-db/plugins/justdo-checklist/i18n/{}.i18n.json");
  this.addI18nFiles(api, "store-db/plugins/justdo-checklist/i18n/seo.{}.i18n.json");

  // Formulas
  this.addI18nFiles(api, "store-db/plugins/justdo-formulas/i18n/{}.i18n.json");
  this.addI18nFiles(api, "store-db/plugins/justdo-formulas/i18n/seo.{}.i18n.json");
  this.addI18nFiles(api, "store-db/plugins/justdo-formulas/i18n/asset.{}.i18n.json");

  // Time Tracker
  this.addI18nFiles(api, "store-db/plugins/justdo-time-tracker/i18n/{}.i18n.json");
  this.addI18nFiles(api, "store-db/plugins/justdo-time-tracker/i18n/seo.{}.i18n.json");
  this.addI18nFiles(api, "store-db/plugins/justdo-time-tracker/i18n/asset.{}.i18n.json");

  // MailDo
  this.addI18nFiles(api, "store-db/plugins/maildo/i18n/{}.i18n.json");
  this.addI18nFiles(api, "store-db/plugins/maildo/i18n/seo.{}.i18n.json");
  this.addI18nFiles(api, "store-db/plugins/maildo/i18n/asset.{}.i18n.json");

  // Meetings
  this.addI18nFiles(api, "store-db/plugins/meetings/i18n/{}.i18n.json");
  this.addI18nFiles(api, "store-db/plugins/meetings/i18n/seo.{}.i18n.json");
  this.addI18nFiles(api, "store-db/plugins/meetings/i18n/asset.{}.i18n.json");

  // Private follow up
  this.addI18nFiles(api, "store-db/plugins/private-follow-up/i18n/{}.i18n.json");
  this.addI18nFiles(api, "store-db/plugins/private-follow-up/i18n/seo.{}.i18n.json");
  this.addI18nFiles(api, "store-db/plugins/private-follow-up/i18n/asset.{}.i18n.json");

  // Resource Management
  this.addI18nFiles(api, "store-db/plugins/resource-management/i18n/{}.i18n.json");
  this.addI18nFiles(api, "store-db/plugins/resource-management/i18n/seo.{}.i18n.json");
  this.addI18nFiles(api, "store-db/plugins/resource-management/i18n/asset.{}.i18n.json");

  // Risk Management
  this.addI18nFiles(api, "store-db/plugins/risk-management/i18n/{}.i18n.json");
  this.addI18nFiles(api, "store-db/plugins/risk-management/i18n/seo.{}.i18n.json");
  this.addI18nFiles(api, "store-db/plugins/risk-management/i18n/asset.{}.i18n.json");

  // Row Styling
  this.addI18nFiles(api, "store-db/plugins/rows-styling/i18n/{}.i18n.json");
  this.addI18nFiles(api, "store-db/plugins/rows-styling/i18n/seo.{}.i18n.json");

  // Task Copy
  this.addI18nFiles(api, "store-db/plugins/task-copy/i18n/{}.i18n.json");
  this.addI18nFiles(api, "store-db/plugins/task-copy/i18n/seo.{}.i18n.json");
  this.addI18nFiles(api, "store-db/plugins/task-copy/i18n/asset.{}.i18n.json");

  // Workload Planner
  this.addI18nFiles(api, "store-db/plugins/workload-planner/i18n/{}.i18n.json");
  this.addI18nFiles(api, "store-db/plugins/workload-planner/i18n/seo.{}.i18n.json");
  this.addI18nFiles(api, "store-db/plugins/workload-planner/i18n/asset.{}.i18n.json");

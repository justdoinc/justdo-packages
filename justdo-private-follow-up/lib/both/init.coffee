...
JustdoPrivateFollowUp = (options) ->
  ...
  @logger = Logger.get("justdo-private-follow-up")
  @JA = JustdoAnalytics.setupConstructorJA(@, "justdo-private-follow-up")
...
Util.inherits JustdoPrivateFollowUp, EventEmitter

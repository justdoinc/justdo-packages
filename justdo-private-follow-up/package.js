Package.describe({
  name: "justdoinc:justdo-private-follow-up",
  version: "1.0.0",
  summary: "",
  git: "https://github.com/justdoinc/justdo-shared-packages/tree/master/justdo-private-follow-up"
});
...
Package.onUse(function (api) {
  ...
  api.addFiles("lib/client/private-follow-up-formatter-and-editor.sass", client);
  api.addFiles("lib/client/private-follow-up-formatter-and-editor.coffee", client);
  ...
  api.export("JustdoPrivateFollowUp", both);
});

...
JustdoProjectConfigTicketsQueues = (options) ->
  ...
  @logger = Logger.get("justdo-project-config-tickets-queues")

  @logger.debug "Init begin"
  @JA = JustdoAnalytics.setupConstructorJA(@, "justdo-project-config-tickets-queues")
...
Util.inherits JustdoProjectConfigTicketsQueues, EventEmitter

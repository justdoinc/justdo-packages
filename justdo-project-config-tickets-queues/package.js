Package.describe({
  name: "justdoinc:justdo-project-config-tickets-queues",
  version: "1.0.0",
  summary: "",
  git: "https://github.com/justdoinc/justdo-shared-packages/tree/master/justdo-project-config-tickets-queues"
});
...
Package.onUse(function (api) {
  ...
  api.export("JustdoProjectConfigTicketsQueues", client);
});

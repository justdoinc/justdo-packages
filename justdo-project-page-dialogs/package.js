...
Package.onUse(function (api) {
  ...
  // change-email-dialog
  this.addI18nFiles(api, "i18n/change-email-dialog/{}.i18n.json");

  // members-management-dialog
  this.addI18nFiles(api, "i18n/members-management-dialog/{}.i18n.json");

  // confirm-edit-members-dialog
  this.addI18nFiles(api, "i18n/confirm-edit-members-dialog/{}.i18n.json");

  // add-member-to-current-project
  this.addI18nFiles(api, "i18n/add-member-to-current-project/{}.i18n.json");

  // invite-members-failed
  this.addI18nFiles(api, "i18n/invite-members-failed/{}.i18n.json");

...
JustdoProjectPane = (options) ->
  # skeleton-version: v0.0.12-client-only
  ...
  @logger = Logger.get("justdo-project-pane")

  @logger.debug "Init begin"
  @JA = JustdoAnalytics.setupConstructorJA(@, "justdo-project-pane")
...
Util.inherits JustdoProjectPane, EventEmitter

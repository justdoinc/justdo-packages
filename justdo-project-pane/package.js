Package.describe({
  name: "justdoinc:justdo-project-pane",
  version: "1.0.0",
  summary: "",
  git: "https://github.com/justdoinc/justdo-shared-packages/tree/master/justdo-project-pane"
});
...
Package.onUse(function (api) {
  ...
  // Templates
  api.addFiles("ui/project-pane/project-pane.sass", client);

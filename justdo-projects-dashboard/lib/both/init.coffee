...
JustdoProjectsDashboard = (options) ->
  ...
  @logger = Logger.get("justdo-projects-dashboard")
  @JA = JustdoAnalytics.setupConstructorJA(@, "justdo-projects-dashboard")
...
Util.inherits JustdoProjectsDashboard, EventEmitter

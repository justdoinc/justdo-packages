_.extend Projects.prototype,
  ...
  _errors_types:
    _.extend {}, JustdoHelpers.common_errors_types,
      ...
      "admin-permission-required": "This operation requires you to have admin permission on this project"
      "user-not-exists": "Couldn't find a user with the provided details"
      "member-already-exists": "Member already exists in this project"
      "unknown-members": "Members don't belong to project"

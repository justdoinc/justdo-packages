    ...
    JustdoEmails.registerEmails "justdo_projects", [
      {
        ...
        custom_options:
          # Since this email may be sent to pre-enrolled users in JustDo, if they click on the unsubscribe link,
          # it would bring the pre-enrolled user to the landing page instead of unsubscribing. That's why we hide unsubscribing link for this email category.
          # 

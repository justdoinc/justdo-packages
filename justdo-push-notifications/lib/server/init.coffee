...
JustdoPushNotifications = (options) ->
  ...
  @logger = Logger.get("justdo-push-notifications")
  @JA = JustdoAnalytics.setupConstructorJA(@, "justdo-push-notifications")
...
Util.inherits JustdoPushNotifications, EventEmitter

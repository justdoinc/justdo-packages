Package.describe({
  name: "justdoinc:justdo-push-notifications",
  version: "1.0.0",
  summary: "",
  git: "https://github.com/justdoinc/justdo-shared-packages/tree/master/justdo-push-notifications"
});
...
Package.onUse(function (api) {
  ...
  api.use("justdoinc:justdo-firebase@1.0.0", server);
  ...
  api.export("JustdoPushNotifications", server);
});

...
JustdoQuickNotes = (options) ->
  ...
  @logger = Logger.get("justdo-quick-notes")
  @JA = JustdoAnalytics.setupConstructorJA(@, "justdo-quick-notes")
...
Util.inherits JustdoQuickNotes, EventEmitter

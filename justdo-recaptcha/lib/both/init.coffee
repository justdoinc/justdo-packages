...
JustdoRecaptcha = (options) ->
  # skeleton-version: v0.0.16
  ...
  @logger = Logger.get("justdo-recaptcha")
  @JA = JustdoAnalytics.setupConstructorJA(@, "justdo-recaptcha")
...
Util.inherits JustdoRecaptcha, EventEmitter

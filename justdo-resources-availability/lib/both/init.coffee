...
JustdoResourcesAvailability = (options) ->
  # skeleton-version: v0.0.19
  ...
  @logger = Logger.get("justdo-resources-availability")
  @JA = JustdoAnalytics.setupConstructorJA(@, "justdo-resources-availability")
...
Util.inherits JustdoResourcesAvailability, EventEmitter

_.extend JustdoResourcesAvailability.prototype,
  registerTaskPaneSection: ->
    ...
    # which we use later
    module.registerTaskPaneSection "JustdoResourcesAvailabilityTaskPaneSection", JustdoResourcesAvailabilityTaskPaneSection
    ...
    Util.inherits JustdoResourcesAvailabilityTaskPaneSection, module.TaskPaneSection

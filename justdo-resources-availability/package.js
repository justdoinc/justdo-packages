Package.describe({
  name: "justdoinc:justdo-resources-availability",
  version: "1.0.0",
  summary: "",
  git: "https://github.com/justdoinc/justdo-shared-packages/tree/master/justdo-resources-availability"
});
...
Package.onUse(function (api) {
  ...
  //   checkNpmVersions({
  //     'colors': '1.1.x'
  //   }, 'justdoinc:justdo-resources-availability')
  ...
  api.export("JustdoResourcesAvailability", both);
});

...
# APP.justdo_roles = new JustdoRoles()
...
APP.getEnv (env) ->
  ...
  APP.collections.JDRProjectsRolesAndGrps = new Mongo.Collection("jdr_projects_roles_and_grps")

  options =
    projects_collection: APP.collections.Projects
    projects_roles_and_grps_collection: APP.collections.JDRProjectsRolesAndGrps

  APP.justdo_roles = new JustdoRoles options

...
options_schema =
  both:
    ...
    projects_roles_and_grps_collection:
      type: "skip-type-check"
      optional: false
      bind_to_instance: true    
...
JustdoRoles = (options) ->
  ...
  @logger = Logger.get("justdo-roles")
  @JA = JustdoAnalytics.setupConstructorJA(@, "justdo-roles")
...
Util.inherits JustdoRoles, EventEmitter

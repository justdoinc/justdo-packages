Package.describe({
  name: "justdoinc:justdo-roles",
  version: "1.0.0",
  summary: "",
  git: "https://github.com/justdoinc/justdo-shared-packages/tree/master/justdo-roles"
});
...
Package.onUse(function (api) {
  ...
  api.addFiles("lib/client/roles-and-groups-manager/roles-and-groups-manager.sass", client);
  api.addFiles("lib/client/roles-and-groups-manager/roles-and-groups-manager.html", client);
  api.addFiles("lib/client/roles-and-groups-manager/roles-and-groups-manager.coffee", client);

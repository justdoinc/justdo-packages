...
JustdoRowsStyling = (options) ->
  ...
  @logger = Logger.get("justdo-rows-styling")

  @logger.debug "Init begin"
  @JA = JustdoAnalytics.setupConstructorJA(@, "justdo-rows-styling")
...
Util.inherits JustdoRowsStyling, EventEmitter

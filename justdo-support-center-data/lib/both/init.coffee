...
JustdoSupportCenterData = (options) ->
  ...
  @logger = Logger.get("justdo-support-center-data")
  @JA = JustdoAnalytics.setupConstructorJA(@, "justdo-support-center-data")
...
Util.inherits JustdoSupportCenterData, EventEmitter

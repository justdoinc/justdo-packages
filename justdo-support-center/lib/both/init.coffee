...
JustdoSupportCenter = (options) ->
  ...
  @logger = Logger.get("justdo-support-center")
  @JA = JustdoAnalytics.setupConstructorJA(@, "justdo-support-center")
...
Util.inherits JustdoSupportCenter, EventEmitter

Package.describe({
  name: "justdoinc:justdo-system-records",
  version: "1.0.0",
  summary: "",
  git: "https://github.com/justdoinc/justdo-shared-packages/tree/master/justdo-system-records"
});
...
Package.onUse(function (api) {
  ...
  //   checkNpmVersions({
  //     'colors': '1.1.x'
  //   }, 'justdoinc:justdo-system-records')
  ...
  api.export("JustdoSystemRecords", both);
});

...
JustdoSystemUpdates = (options) ->
  # skeleton-version: v0.0.10
  ...
  @logger = Logger.get("justdo-system-updates")
  @JA = JustdoAnalytics.setupConstructorJA(@, "justdo-system-updates")
...
Util.inherits JustdoSystemUpdates, EventEmitter

...
TabSwitcherDropdown = (options) ->
  ...
  @logger = Logger.get("justdo-project-config-ui")
...
Util.inherits TabSwitcherDropdown, EventEmitter

_.extend TabSwitcherDropdown.prototype,
  _error: JustdoHelpers.constructor_error

  _immediateInit: ->
    @sections_dep = new Tracker.Dependency()
    @sections = {}

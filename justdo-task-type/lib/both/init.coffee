...
JustdoTaskType = (options) ->
  ...
  @logger = Logger.get("justdo-task-type")
  @JA = JustdoAnalytics.setupConstructorJA(@, "justdo-task-type")
...
Util.inherits JustdoTaskType, EventEmitter

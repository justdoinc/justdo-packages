_.extend JustdoTaskType.prototype,
  registerTaskPaneSection: ->
    ...
    # which we use later
    module.registerTaskPaneSection "JustdoTaskTypeTaskPaneSection", JustdoTaskTypeTaskPaneSection
    ...
    Util.inherits JustdoTaskTypeTaskPaneSection, module.TaskPaneSection

...
JustdoTasksCollectionsManager = (options) ->
  # skeleton-version: v0.0.14
  ...
  @logger = Logger.get("justdo-tasks-collection")
  @JA = JustdoAnalytics.setupConstructorJA(@, "justdo-tasks-collection")
  ...
  # Since in justdo-tasks-collections-manager the collections are created in the init process
  # we have to call @_attachCollectionsSchemas() after init.
...
Util.inherits JustdoTasksCollectionsManager, EventEmitter

Package.describe({
  name: "justdoinc:justdo-tasks-collections-manager",
  version: "1.0.0",
  summary: "",
  git: "https://github.com/justdoinc/justdo-shared-packages/tree/master/justdo-tasks-collections-manager"
});
...
Package.onUse(function (api) {
  ...
  api.addFiles("lib/both/collections.coffee", both);
  api.addFiles("lib/both/tasks-schema.coffee", both);
  api.addFiles("lib/both/tasks-private-data-schema.coffee", both);
  api.addFiles("lib/both/tasks-collection-constructor-and-initiator.js", both);

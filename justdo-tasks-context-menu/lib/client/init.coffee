...
JustdoTasksContextMenu = (options) ->
  ...
  @logger = Logger.get("justdo-tasks-context-menu")

  @logger.debug "Init begin"
  @JA = JustdoAnalytics.setupConstructorJA(@, "justdo-tasks-context-menu")
...
Util.inherits JustdoTasksContextMenu, EventEmitter

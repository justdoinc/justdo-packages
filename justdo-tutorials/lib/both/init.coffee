...
JustdoTutorials = (options) ->
  ...
  @logger = Logger.get("justdo-tutorials")
  @JA = JustdoAnalytics.setupConstructorJA(@, "justdo-tutorials")
...
Util.inherits JustdoTutorials, EventEmitter

...
JustdoUsageStatistics = (options) ->
  ...
  @logger = Logger.get("justdo-usage-statistics")
  @JA = JustdoAnalytics.setupConstructorJA(@, "justdo-usage-statistics")
...
Util.inherits JustdoUsageStatistics, EventEmitter

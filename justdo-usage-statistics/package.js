Package.describe({
  name: "justdoinc:justdo-usage-statistics",
  version: "1.0.0",
  summary: "",
  git: "https://github.com/justdoinc/justdo-shared-packages/tree/master/justdo-usage-statistics"
});
...
Package.onUse(function (api) {
  ...
  //   checkNpmVersions({
  //     'colors': '1.1.x'
  //   }, 'justdoinc:justdo-usage-statistics')
  ...
  api.export("JustdoUsageStatistics", server);
});

...
# APP.justdo_user_active_position = new JustdoUserActivePosition()
...
APP.getEnv (env) ->
  ...
  if Meteor.isServer
    APP.collections.UsersActivePositionsLedger = new Mongo.Collection(JustdoUserActivePosition.users_active_position_ledger_collection_name)

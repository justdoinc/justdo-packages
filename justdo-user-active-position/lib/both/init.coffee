...
JustdoUserActivePosition = (options) ->
  ...
  @logger = Logger.get("justdo-user-active-position")
  @JA = JustdoAnalytics.setupConstructorJA(@, "justdo-user-active-position")
...
Util.inherits JustdoUserActivePosition, EventEmitter

Package.describe({
  name: "justdoinc:justdo-user-active-position",
  version: "1.0.0",
  summary: "",
  git: "https://github.com/justdoinc/justdo-shared-packages/tree/master/justdo-user-active-position"
});
...
Package.onUse(function (api) {
  ...
  //   checkNpmVersions({
  //     'colors': '1.1.x'
  //   }, 'justdoinc:justdo-user-active-position')
  ...
  api.export("JustdoUserActivePosition", both);
});

Package.describe({
  name: "justdoinc:justdo-user-config-ui",
  version: "1.0.0",
  summary: "",
  git: "https://github.com/justdoinc/justdo-shared-packages/tree/master/justdo-user-config-ui"
});
...
Package.onUse(function (api) {
  ...
  api.addFiles("lib/client/templates/user-config.html", client);
  api.addFiles("lib/client/templates/user-config.coffee", client);
  api.addFiles("lib/client/templates/user-config.sass", client);
  ...
  api.export("JustdoUserConfigUi", client);
});

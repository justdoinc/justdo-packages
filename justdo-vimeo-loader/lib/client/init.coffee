...
JustdoVimeoLoader = (options) ->
  # skeleton-version: v3.0.2-client-only
  ...
  @logger = Logger.get("justdo-vimeo-loader")

  @logger.debug "Init begin"
  @JA = JustdoAnalytics.setupConstructorJA(@, "justdo-vimeo-loader")
...
Util.inherits JustdoVimeoLoader, EventEmitter

...
MeetingsManagerPlugin = (options) ->
  ...
  @logger = Logger.get("meetings-manager-plugin")
...
Util.inherits MeetingsManagerPlugin, EventEmitter
...
_.extend MeetingsManagerPlugin.prototype,
  ...
  _bothImmediateInit: ->
    ...
    @meetings_manager = new MeetingsManager @options

_.extend MeetingsManager.prototype,
  ...
  _errors_types: _.extend {}, JustdoHelpers.common_errors_types,
    "invalid-request": "Your request was invalid"
    "duplicate-task": "The specified task already exists in the list"

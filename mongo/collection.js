  ...
  _maybeSetUpReplication(name, {
    ...
    const ok = self._connection.registerStore(name, {
      ...
      update(msg) {
        ...
        var doc = self._collection._docs._map[mongoId]; // Originally, the code here was:
                                                        // var doc = self._collection.findOne(mongoId);
                                                        // This is redundant to the serious overhead of
                                                        // findOne + the fact that a clone is done in the
                                                        // process which is also redundant and expensive.

...
env_vars_to_expose = [
  ...
  "FILESTACK_KEY"
  "USER_ACTIVE_POSITION_ENABLED"
  "ON_GRID_USER_ACTIVE_POSITION_ENABLED"
  "I18N_DEFAULT_LANGUAGE"
  "I18N_ALL_SUPPORTED_LANGUAGES"
  "I18N_CORE_SUPPORTED_LANGUAGES"
...
WebApp.connectHandlers.use (req, res, next) =>
  ...
  req.dynamicHead += """<script>env = JSON.parse(atob('#{getBase64EncodedEnvJSON()}'));</script>"""

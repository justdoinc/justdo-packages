...
(function ($) {
  ...
  function SlickGrid(container, data, columns, options) {
    ...
    function init() {
      ...
      $headers = $("<div class='slick-header-columns' style='left: 0' />").appendTo($headerScroller);
    ...
    function createColumnHeaders() {
      ...
      for (var i = 0; i < columns.length; i++) {
        ...
        var header = $("<div class='ui-state-default slick-header-column' />")
            .html("<span class='slick-column-name'>" + JustdoHelpers.xssGuard(m.name, {allow_html_parsing: true, enclosing_char: ''}) + "</span>")
    ...
    function updateCell(row, cell, skip_same_tick_block) {
      ...
      JustdoHelpers.sameTickCacheSet(same_tick_updated_key, true);
    ...
    function getHScrollHeight() {
      return viewportHasHScroll ? scrollbarDimensions.height : 0;
    }
    ...
    function scrollRowIntoView(row, doPaging) {
      ...
      if (!options.dynamicRowHeight) {
        ...
        var rowAtBottom = getRowTopPosition(row + 1) - viewportH + getHScrollHeight();
        ...
        var rowAtTop = rowTop;
        var rowAtBottom = rowBottom - viewportH + getHScrollHeight();

        // need to page down?
        if (scrollTop < rowAtBottom) {
          scrollTo(doPaging ? rowAtTop : rowAtBottom);
        }
        // or page up?
        else if (scrollTop > rowAtTop) {
          scrollTo(doPaging ? rowAtBottom : rowAtTop);
        }
      }
    }
